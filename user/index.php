    ...
    <div class="container-md">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="src/img/arthome.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="500"
                    height="500" loading="lazy">
            </div>
            <div class="col-lg-6" style="color :#005AE0;
            font-family: Merriweather, serif;
            font-weight: 900;
            font-style: normal;">
                <h1 class="display-5 fw-bold lh-1 mb-3">Selamat Datang</h1>
                <p class="fs-5">
                Poliwangi Smart adalah platform untuk masyarakat kampus guna mengatasi keluhan, memberikan saran, serta memperbaiki sarana dan prasarana. Kami memfasilitasi interaksi antara mahasiswa dan lembaga kampus demi kemajuan Poliwangi yang lebih baik.
                </p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="formulir/index.php">
                        <button type="button" class="btn btn-primary btn-lg px-4 me-md-2">Lapor !</button>
                    </a>
                </div>
            </div>
        </div>
